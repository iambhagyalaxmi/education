...
async function main() {
  ...
  const galleryImages = [
    // Hero
    { url: 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2070', title: 'Modern classroom with students learning', description: 'Hero image 1', category: 'Hero', order: 1 },
    { url: 'https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=2070', title: 'Professional teacher conducting a class', description: 'Hero image 2', category: 'Hero', order: 2 },
    ...
    { url: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=2070', title: 'Science Laboratory', description: 'Well-equipped labs for practical experiments.', category: 'Campus', order: 5 },
    { url: 'https://images.unsplash.com/photo-1507842217343-583bb7270b66?q=80&w=2190', title: 'Library', description: 'Thousands of books and digital resources.', category: 'Campus', order: 6 },
    { url: 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?q=80&w=2069', title: 'Hostel', description: 'Comfortable and safe accommodation on campus.', category: 'Campus', order: 7 },
    { url: 'https://images.unsplash.com/photo-1525610553991-2bede1a236e2?q=80&w=2070', title: 'Cafeteria', description: 'Hygienic and healthy food for all students.', category: 'Campus', order: 8 },
    { url: 'https://images.unsplash.com/photo-1526676037777-05a232554f77?q=80&w=2070', title: 'Sports Ground', description: 'Expansive facilities for outdoor and indoor sports.', category: 'Campus', order: 9 },
    { url: 'https://images.unsplash.com/photo-1505236858219-8359eb29e329?q=80&w=2162', title: 'Auditorium', description: 'Large capacity auditorium for events and seminars.', category: 'Campus', order: 10 },
    { url: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=2069', title: 'Transport Facilities', description: 'Safe and wide-reaching bus network.', category: 'Campus', order: 11 },
    { url: 'https://images.unsplash.com/photo-1523731407965-2430cd12f5e4?q=80&w=2070', title: 'Green Campus', description: 'Eco-friendly and lush green environment.', category: 'Campus', order: 12 },

    // Featured Sections
    { url: 'https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=2070', title: 'Classroom Experience', description: 'Learn in smart classrooms equipped with the latest technology.', category: 'Featured', order: 1 },
    { url: 'https://images.unsplash.com/photo-1523580494112-071dcb84968c?q=80&w=2070', title: 'Campus Life', description: 'Experience a vibrant student life with clubs, events, and extracurricular activities.', category: 'Featured', order: 2 },
    { url: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=2084', title: 'Placement Success', description: 'Build your career with excellent placement opportunities.', category: 'Featured', order: 3 },
    { url: 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?q=80&w=2069', title: 'Hostel Facilities', description: 'Safe, comfortable, and well-maintained accommodation for students.', category: 'Featured', order: 4 },
    { url: 'https://images.unsplash.com/photo-1507842217343-583bb7270b66?q=80&w=2190', title: 'Library', description: 'Access thousands of books, journals, and digital resources.', category: 'Featured', order: 5 },
    ...
    { url: 'https://images.unsplash.com/photo-1507842217343-583bb7270b66?q=80&w=2190', title: 'Library', description: '', category: 'Slider', order: 5 },
    { url: 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?q=80&w=2069', title: 'Hostel', description: '', category: 'Slider', order: 6 },
    { url: 'https://images.unsplash.com/photo-1523580494112-071dcb84968c?q=80&w=2070', title: 'Cultural Events', description: '', category: 'Slider', order: 7 },
    { url: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=2084', title: 'Placement Activities', description: '', category: 'Slider', order: 8 },
  ];
