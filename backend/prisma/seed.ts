...
async function main() {
  ...
  const galleryImages = [
    ...
    { url: 'https://images.unsplash.com/photo-1587280501635-68a0e82cd5ff?q=80&w=2070', title: 'Sports Ground', description: 'Expansive facilities for outdoor and indoor sports.', category: 'Campus', order: 9 },
    ...
    { url: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=2071', title: 'Campus Life', description: 'Experience a vibrant student life with clubs, events, and extracurricular activities.', category: 'Featured', order: 2 },
    ...
    { url: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=2071', title: 'Cultural Events', description: '', category: 'Slider', order: 7 },
