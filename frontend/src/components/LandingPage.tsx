...
const FALLBACK_IMAGES = {
  hero: [
    { id: 'h1', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428461/education_app/hero/hero_01_modern_classroom.jpg', title: 'Modern classroom with students learning', description: '', category: 'Hero', order: 1 },
    { id: 'h2', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428462/education_app/hero/hero_02_professional_teacher.jpg', title: 'Professional teacher conducting a class', description: '', category: 'Hero', order: 2 },
    { id: 'h3', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428464/education_app/hero/hero_03_learning_environment.jpg', title: 'Bright and clean learning environment', description: '', category: 'Hero', order: 3 },
  ],
  campus: [
    { id: 'c1', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428465/education_app/campus/campus_01_institute_front_gate.jpg', title: 'Institute Front Gate', description: 'Our grand entrance welcoming future leaders.', category: 'Campus', order: 1 },
    { id: 'c2', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428464/education_app/hero/hero_03_learning_environment.jpg', title: 'Main Academic Building', description: 'State-of-the-art infrastructure for advanced learning.', category: 'Campus', order: 2 },
    { id: 'c3', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428468/education_app/campus/campus_03_smart_classroom.jpg', title: 'Smart Classroom', description: 'Interactive boards and modern tech for every student.', category: 'Campus', order: 3 },
    { id: 'c4', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428469/education_app/campus/campus_04_computer_laboratory.jpg', title: 'Computer Laboratory', description: 'High-end workstations with the latest software.', category: 'Campus', order: 4 },
    { id: 'c5', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428470/education_app/campus/campus_05_science_laboratory.jpg', title: 'Science Laboratory', description: 'Well-equipped labs for practical experiments.', category: 'Campus', order: 5 },
    { id: 'c6', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428472/education_app/campus/campus_06_library.jpg', title: 'Library', description: 'Thousands of books and digital resources.', category: 'Campus', order: 6 },
    { id: 'c7', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428473/education_app/campus/campus_07_hostel.jpg', title: 'Hostel', description: 'Comfortable and safe accommodation on campus.', category: 'Campus', order: 7 },
    { id: 'c8', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428475/education_app/campus/campus_08_cafeteria.jpg', title: 'Cafeteria', description: 'Hygienic and healthy food for all students.', category: 'Campus', order: 8 },
    { id: 'c9', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428476/education_app/campus/campus_09_sports_ground.jpg', title: 'Sports Ground', description: 'Expansive facilities for outdoor and indoor sports.', category: 'Campus', order: 9 },
    { id: 'c10', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428477/education_app/campus/campus_10_auditorium.jpg', title: 'Auditorium', description: 'Large capacity auditorium for events and seminars.', category: 'Campus', order: 10 },
    { id: 'c11', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428479/education_app/campus/campus_11_transport_facilities.jpg', title: 'Transport Facilities', description: 'Safe and wide-reaching bus network.', category: 'Campus', order: 11 },
    { id: 'c12', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428480/education_app/campus/campus_12_green_campus.jpg', title: 'Green Campus', description: 'Eco-friendly and lush green environment.', category: 'Campus', order: 12 },
  ],
  featured: [
    { id: 'f1', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428462/education_app/hero/hero_02_professional_teacher.jpg', title: 'Classroom Experience', description: 'Learn in smart classrooms equipped with the latest technology.', category: 'Featured', order: 1 },
    { id: 'f2', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428483/education_app/featured/featured_02_campus_life.jpg', title: 'Campus Life', description: 'Experience a vibrant student life with clubs, events, and extracurricular activities.', category: 'Featured', order: 2 },
    { id: 'f3', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428484/education_app/featured/featured_03_placement_success.jpg', title: 'Placement Success', description: 'Build your career with excellent placement opportunities.', category: 'Featured', order: 3 },
    { id: 'f4', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428473/education_app/campus/campus_07_hostel.jpg', title: 'Hostel Facilities', description: 'Safe, comfortable, and well-maintained accommodation for students.', category: 'Featured', order: 4 },
    { id: 'f5', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428472/education_app/campus/campus_06_library.jpg', title: 'Library', description: 'Access thousands of books, journals, and digital resources.', category: 'Featured', order: 5 },
    { id: 'f6', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428470/education_app/campus/campus_05_science_laboratory.jpg', title: 'Laboratories', description: 'Hands-on learning through advanced laboratories.', category: 'Featured', order: 6 },
  ],
  slider: [
    { id: 's1', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428465/education_app/campus/campus_01_institute_front_gate.jpg', title: 'Institute Front Gate', description: '', category: 'Slider', order: 1 },
    { id: 's2', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428464/education_app/hero/hero_03_learning_environment.jpg', title: 'Campus View', description: '', category: 'Slider', order: 2 },
    { id: 's3', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428468/education_app/campus/campus_03_smart_classroom.jpg', title: 'Classroom', description: '', category: 'Slider', order: 3 },
    { id: 's4', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428470/education_app/campus/campus_05_science_laboratory.jpg', title: 'Laboratory', description: '', category: 'Slider', order: 4 },
    { id: 's5', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428472/education_app/campus/campus_06_library.jpg', title: 'Library', description: '', category: 'Slider', order: 5 },
    { id: 's6', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428473/education_app/campus/campus_07_hostel.jpg', title: 'Hostel', description: '', category: 'Slider', order: 6 },
    { id: 's7', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428483/education_app/featured/featured_02_campus_life.jpg', title: 'Cultural Events', description: '', category: 'Slider', order: 7 },
    { id: 's8', url: 'https://res.cloudinary.com/adte9bpr/image/upload/v1783428484/education_app/featured/featured_03_placement_success.jpg', title: 'Placement Activities', description: '', category: 'Slider', order: 8 },
  ]
};
