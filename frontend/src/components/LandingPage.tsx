...
const FALLBACK_IMAGES = {
  hero: [
    { id: 'h1', url: 'https://picsum.photos/seed/hero1/1920/1080', title: 'Modern classroom with students learning', description: '', category: 'Hero', order: 1 },
    { id: 'h2', url: 'https://picsum.photos/seed/hero2/1920/1080', title: 'Professional teacher conducting a class', description: '', category: 'Hero', order: 2 },
    { id: 'h3', url: 'https://picsum.photos/seed/hero3/1920/1080', title: 'Bright and clean learning environment', description: '', category: 'Hero', order: 3 },
  ],
  campus: [
    { id: 'c1', url: 'https://picsum.photos/seed/campus1/800/600', title: 'Institute Front Gate', description: 'Our grand entrance welcoming future leaders.', category: 'Campus', order: 1 },
    { id: 'c2', url: 'https://picsum.photos/seed/campus2/800/600', title: 'Main Academic Building', description: 'State-of-the-art infrastructure for advanced learning.', category: 'Campus', order: 2 },
    { id: 'c3', url: 'https://picsum.photos/seed/campus3/800/600', title: 'Smart Classroom', description: 'Interactive boards and modern tech for every student.', category: 'Campus', order: 3 },
    { id: 'c4', url: 'https://picsum.photos/seed/campus4/800/600', title: 'Computer Laboratory', description: 'High-end workstations with the latest software.', category: 'Campus', order: 4 },
    { id: 'c5', url: 'https://picsum.photos/seed/campus5/800/600', title: 'Science Laboratory', description: 'Well-equipped labs for practical experiments.', category: 'Campus', order: 5 },
    { id: 'c6', url: 'https://picsum.photos/seed/campus6/800/600', title: 'Library', description: 'Thousands of books and digital resources.', category: 'Campus', order: 6 },
    { id: 'c7', url: 'https://picsum.photos/seed/campus7/800/600', title: 'Hostel', description: 'Comfortable and safe accommodation on campus.', category: 'Campus', order: 7 },
    { id: 'c8', url: 'https://picsum.photos/seed/campus8/800/600', title: 'Cafeteria', description: 'Hygienic and healthy food for all students.', category: 'Campus', order: 8 },
    { id: 'c9', url: 'https://picsum.photos/seed/campus9/800/600', title: 'Sports Ground', description: 'Expansive facilities for outdoor and indoor sports.', category: 'Campus', order: 9 },
    { id: 'c10', url: 'https://picsum.photos/seed/campus10/800/600', title: 'Auditorium', description: 'Large capacity auditorium for events and seminars.', category: 'Campus', order: 10 },
    { id: 'c11', url: 'https://picsum.photos/seed/campus11/800/600', title: 'Transport Facilities', description: 'Safe and wide-reaching bus network.', category: 'Campus', order: 11 },
    { id: 'c12', url: 'https://picsum.photos/seed/campus12/800/600', title: 'Green Campus', description: 'Eco-friendly and lush green environment.', category: 'Campus', order: 12 },
  ],
  featured: [
    { id: 'f1', url: 'https://picsum.photos/seed/feat1/1200/800', title: 'Classroom Experience', description: 'Learn in smart classrooms equipped with the latest technology.', category: 'Featured', order: 1 },
    { id: 'f2', url: 'https://picsum.photos/seed/feat2/1200/800', title: 'Campus Life', description: 'Experience a vibrant student life with clubs, events, and extracurricular activities.', category: 'Featured', order: 2 },
    { id: 'f3', url: 'https://picsum.photos/seed/feat3/1200/800', title: 'Placement Success', description: 'Build your career with excellent placement opportunities.', category: 'Featured', order: 3 },
    { id: 'f4', url: 'https://picsum.photos/seed/feat4/1200/800', title: 'Hostel Facilities', description: 'Safe, comfortable, and well-maintained accommodation for students.', category: 'Featured', order: 4 },
    { id: 'f5', url: 'https://picsum.photos/seed/feat5/1200/800', title: 'Library', description: 'Access thousands of books, journals, and digital resources.', category: 'Featured', order: 5 },
    { id: 'f6', url: 'https://picsum.photos/seed/feat6/1200/800', title: 'Laboratories', description: 'Hands-on learning through advanced laboratories.', category: 'Featured', order: 6 },
  ],
  slider: [
    { id: 's1', url: 'https://picsum.photos/seed/slide1/1920/800', title: 'Institute Front Gate', description: '', category: 'Slider', order: 1 },
    { id: 's2', url: 'https://picsum.photos/seed/slide2/1920/800', title: 'Campus View', description: '', category: 'Slider', order: 2 },
    { id: 's3', url: 'https://picsum.photos/seed/slide3/1920/800', title: 'Classroom', description: '', category: 'Slider', order: 3 },
    { id: 's4', url: 'https://picsum.photos/seed/slide4/1920/800', title: 'Laboratory', description: '', category: 'Slider', order: 4 },
    { id: 's5', url: 'https://picsum.photos/seed/slide5/1920/800', title: 'Library', description: '', category: 'Slider', order: 5 },
    { id: 's6', url: 'https://picsum.photos/seed/slide6/1920/800', title: 'Hostel', description: '', category: 'Slider', order: 6 },
    { id: 's7', url: 'https://picsum.photos/seed/slide7/1920/800', title: 'Cultural Events', description: '', category: 'Slider', order: 7 },
    { id: 's8', url: 'https://picsum.photos/seed/slide8/1920/800', title: 'Placement Activities', description: '', category: 'Slider', order: 8 },
  ]
};
