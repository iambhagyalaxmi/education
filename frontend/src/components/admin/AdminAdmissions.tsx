...
export default function AdminAdmissions({ activeTab }: { activeTab: string }) {
  ...
  const renderEnrollment = () => (
    <div className="flex flex-col items-center justify-center h-[60vh] text-center animate-fade-in-up">
      ...
      <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">Enrollment Finalization</h2>
      <p className="text-slate-500 dark:text-slate-400 max-w-md">
        This section is for converting approved applicants into active students.
      </p>
    </div>
  );
