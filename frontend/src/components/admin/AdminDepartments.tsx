        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {[
                { name: 'Computer Science', hod: 'Dr. Sarah Johnson', faculty: 24, students: 850, status: 'Active' },
                { name: 'Information Technology', hod: 'Prof. Michael Chen', faculty: 18, students: 620, status: 'Active' },
                { name: 'Mechanical Engineering', hod: 'Dr. Robert Smith', faculty: 20, students: 540, status: 'Active' },
                { name: 'Business Administration', hod: 'Dr. Anita Patel', faculty: 15, students: 480, status: 'Active' },
              ].map((dept, i) => (
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:text-white" placeholder="e.g. Civil Engineering" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Department Code *</label>
              <input type="text" className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:text-white" placeholder="e.g. CE" />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea rows={4} className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:text-white" placeholder="Enter department description..."></textarea>
            </div>
          </div>
